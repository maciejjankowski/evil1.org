...
[x] | T210 | Convert remaining pages from page_html approach to proper Jekyll structure | DoD: Convert company/index.md, members/index.md, news/index.md, profile/index.md from page_html to clean Jekyll markdown; remove page_html frontmatter; test builds pass
[x] | T211 | Create reusable components library from hellfire designs | DoD: Extract 15+ reusable components from designs into _includes/; create comprehensive documentation; all components tested and working
