...
[x] | T528 | Create "Your Evil Profile" feature mocking MBTI test with original name | GPT-4o | Design Corporate Evil Assessment Tool (CEAT) personality test parody, create profile page following satirical tone, ensure external CSS only, test build and visual tests
