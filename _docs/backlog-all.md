...
[x] | T528 | Implement dark patterns strategy across site for satirical corporate critique | GPT-4.1 | Deploy dark patterns from _docs/dark-patterns-strategy.md including confirmshaming, artificial scarcity, and subscription manipulation while maintaining satirical transparency
