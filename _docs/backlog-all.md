...
[x] | T550 | Implement Evil 500 paid certification system for companies | GPT-4.1 | Create Evil 500 ranking system, add certification status to company data, implement PR-washed labels, create certification program pages, add conditional content rendering based on payment status
