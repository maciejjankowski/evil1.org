...
[x] | T550 | Create design playbook for buzzword products with artificial restrictions | GPT-4.1 | Create comprehensive article exposing tactics for building products with DRM-like restrictions (juice bags, NFC potatoes, etc.), following satirical tone of existing articles
